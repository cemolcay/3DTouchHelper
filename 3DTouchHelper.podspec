#
#  Be sure to run `pod spec lint 3DTouchHelper.podspec' to ensure this is a
...
```
  ...
  s.homepage     = "https://github.com/cemolcay/3DTouchHelper"
  ...
  s.source       = { :git => "https://github.com/cemolcay/3DTouchHelper.git", :tag => "v0.1" }
  ...
  s.source_files  = "3DTouchHelper/3DTouchHelper/*.swift"
